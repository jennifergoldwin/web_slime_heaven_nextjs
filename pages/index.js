    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <div className="bg-about relative flex justify-center items-center ">
          <div className="flex justify-center items-center pb-12 sm:pb-28 mb-12">
            ...
            <div className="font-poppins text-2xl p-8 flex mb-12">
              <span className="text-white text-6xl font-bold -mt-4 flex">
                “
              </span>
              <div>
                <div className="text-white pr-8 ">
                  <span className="color-title font-bold pr-3">
                    SLIME HAVEN
                  </span>
                  is a free to play pet raising simulator with
                </div>
                <div className="text-white pl-0 sm:pl-8 flex">
                  <div>
                    adorable colourful slimes for you to
                    <span className="color-title font-bold pl-3">
                      BREED AND BOND WITH!
                    </span>
                  </div>
                </div>
              </div>
              <span className="text-white text-6xl font-bold  flex justify-end items-end">
                “
              </span>
            </div>
          </div>
        ...
        <div className="flex justify-center items-center flex-col">
          <h1 className="title-text py-12 sm:py-4 color-title font-cp text-center">
            PLAY TO EARN
          </h1>
          ...
          <div className="py-8 px-4 mb-8 md:p-8 w-5/6">
            <div className="grid grid-custom-col mx-auto container gap-8">
              <div className="grid justify-items-end items-center">
                <img
                  className="glowing-png"
                  src="/assets/images/LOCA.png"
                  alt=""
                />

                <div className="text-right">
                  <h1 className="title-text color-title font-cp ">
                    LOVE CAKE (LOCA)
                  </h1>
                  <span className="desc-text flex justify-center items-center flex-col">
                    <p className="font-poppins">
                      A premium currency used for essential activities within
                      Slime Haven! Use it to breed your slimes, Buy Slimes from
                      the marketplace And many more! You can obtain these from
                      fulfilling daily quests!
                    </p>
                  </span>
                </div>
              </div>
              ...
              <div className="">
                ...
                <div className="text-left">
                  ...
                  <span className="desc-text flex justify-center items-center flex-col">
                    <p className="font-poppins">
                      A core currency of the creo engine ecosystem. You can
                      convert your love cakes into Creo to cash out and earn
                      income!
                    </p>
                  </span>
                </div>
        ...
        <div>
          <h1 className="title-text py-4 color-title font-cp text-center">
          ...
          <div className="py-2 md:py-12 container mx-auto flex flex-wrap justify-center items-center">
            <div className="w-full md:w-1/2">
              ...
              >
                <g
                  ...
                  transform="translate(-220.079 -7802.875)"
                >
                  <image
                    id="randomslimes_006"
                    width="615"
                    height="615"
                    transform="translate(301.079 7802.875)"
                    xlinkHref="/assets/images/randomslimes_006.png"
                  />
                  <image
                    className="glowing-png"
                    id="egg_earth"
                    width="152"
                    height="152"
                    transform="translate(250.079 8435.875)"
                    xlinkHref="/assets/images/egg_earth.png"
                  />
                  <image
                    className="glowing-png"
                    id="egg_dark"
                    width="153"
                    height="153"
                    transform="translate(404.079 8435.875)"
                    xlinkHref="/assets/images/egg_dark.png"
                  />
                  <image
                    className="glowing-png"
                    id="egg_thunder"
                    width="153"
                    height="152"
                    transform="translate(559.079 8435.875)"
                    xlinkHref="/assets/images/egg_thunder.png"
                  />
                  <image
                    className="glowing-png"
                    id="egg_nature"
                    width="153"
                    height="153"
                    transform="translate(714.079 8435.875)"
                    xlinkHref="/assets/images/egg_nature.png"
                  />
                  <image
                    className="glowing-png"
                    id="egg_water_1_"
                    data-name="egg_water(1)"
                    width="152"
                    height="152"
                    transform="translate(869.079 8435.875)"
                    xlinkHref="/assets/images/egg_water.png"
                  />
                </g>
              </svg>
            </div>
            <div className="w-full md:w-1/2">
              <div className="text-center">
                <h1 className="title-text py-4  color-title font-cp">
                  FABLED SLIMES
                </h1>
                <img
                  className="p-12"
                  src="/assets/images/fabled-desc.png"
                  alt=""
                />
              </div>
            </div>
        ...
        <div className="text-center font-cp flex flex-col justify-center items-center">
          <h1 className="title-text py-4  color-title ">
          ...
          <span className="desc-text flex justify-center items-center flex-col">
            <p className="w-full sm:w-3/5 font-poppins px-8 sm:px-0">
              Your slimes can be used within Evermore Knights as assistants in
              battle! Your slimes aren’t just lovely pets, but they’re
              travellers in-between worlds of all shapes and sizes! The
              Creoverse opens a lot of possibilities for you and your adorable
              little friends!
            </p>
          </span>
        </div>
        ...
        <div className="text-center font-cp">
          ...
          <span className="desc-text flex justify-center items-center flex-col px-8 sm:px-0">
            <p className="w-full sm:w-3/5 ">
              You need to have at least FOUR SLIMES to start the game in SLIME
              HAVEN. You could get it in various ways :
            </p>
            <p>
          ...
          <div className="container mx-auto flex flex-wrap w-full py-8">
            ...
            <div className="w-full px-4 mt-7 lg:w-1/3 md:w-1/3 text-center flex justify-center items-center">
              <div className="grid grid-cols-3 gap-8">
                <a
                  href="https://www.instagram.com/creoengine.official/"
                  rel="noreferrer"
                  target="_blank"
                ...
                <a
                  href="https://t.me/CreoEngineChannel"
                  target="_blank"
                  rel="noreferrer"
                  className="btn-footer"
                >
